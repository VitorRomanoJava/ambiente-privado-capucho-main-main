...
export const LongSleeveViewer = forwardRef((props: CommonViewerProps, ref) => {
  ...
  return (
    <Canvas id="product-canvas" camera={{ position: [0, 0, 15], fov: 50 }} shadows gl={{ preserveDrawingBuffer: true }}>
